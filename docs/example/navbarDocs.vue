  ...
  <doc-section id="navbar" name="Navbar">
    <div class="bs-example">
      <navbar :placement="placement" :type="type">
        <a href="/" title="Home" slot="brand" class="navbar-brand">VueBootstrap</a>
        <dropdown text="Component List" type="primary">
          <li v-for="s in sections"><a :href="'#'+s.id" v-text="s.name"></a></li>
        </dropdown>
        <li>
          <a href="https://github.com/wffranco/vue-bootstrap" target="_blank">
    ...
    <doc-code language="markup">
      &lt;navbar placement="top" type="default">
        &lt;!-- Brand as slot -->
        &lt;a slot="brand" href="/" title="Home" class="navbar-brand">VueBootstrap&lt;/a>
        ...
        &lt;li slot="right">
          &lt;a href="https://github.com/wffranco/vue-bootstrap" target="_blank">Fork...&lt;/a>
        &lt;/li>
      &lt;/navbar>
    </doc-code>
    <doc-table>
